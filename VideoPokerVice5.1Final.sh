...
#Video Poker Vice Card Game Linux CLI v5.1 Final
#Version:5.0 (final)
#Author:LexT
#Date:05/25/2023
...
#"Card Decks: 1 (Standard 52)"
#"Tokens per Play: 5"
#"Hold Two First Cards (Example): 11000"
#"Auto-deal: enabled"
#"Default Action: Draw All Cards"
...
echo -e ""
echo -e "${URBAN}Keys:${REGULAR} q: Quit / 1: Hold / 0: Draw"
...
echo -e "WinPercentage:${POINTS}$((100*totalNumberWins/Games))${REGULAR}\u0025 Profits:${POINTS}$((100*totalPointsWon/(creditsUsed*5)))${REGULAR}\u0025"
echo " "
echo " "
...
read -p $'Cards to \033[0;32mhold\033[0;0m? ' response
printf "\033c"
echo " "
...
echo -e "${URBAN}     ${REGULAR} ${!mySuits[$Reel1]}\033[40m\e[1m${myFaces[$Reel1]}${mySymbols[$Reel1]}\033[49m  ${!mySuits[$Reel2]}\033[40m\e[1m${myFaces[$Reel2]}${mySymbols[$Reel2]}\033[49m  ${!mySuits[$Reel3]}\033[40m\e[1m${myFaces[$Reel3]}${mySymbols[$Reel3]}\033[49m  ${!mySuits[$Reel4]}\033[40m\e[1m${myFaces[$Reel4]}${mySymbols[$Reel4]}\033[49m  ${!mySuits[$Reel5]}\033[40m\e[1m${myFaces[$Reel5]}${mySymbols[$Reel5]}\033[49m  ${REGULAR}\033[49m\e[0m "
echo -e " " 
i=0
while [ $i -le 5 ]; do
  for s in / - \\ \|; do
