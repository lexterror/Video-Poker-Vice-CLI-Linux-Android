...
myCards=("01C" "01D" "01H" "01S" "02C" "02D" "02H" "02S" "03C" "03D" "03H" "03S" "04C" "04D" "04H" "04S" "05C" "05D" "05H" "05S" "06C" "06D" "06H" "06S" "07C" "07D" "07H" "07S" "08C" "08D" "08H" "08S" "09C" "09D" "09H" "09S" "10C" "10D" "10H" "10S" "11C" "11D" "11H" "11S" "12C" "12D" "12_H" "12S" "13C" "13D" "13H" "13S")
...
echo "************************"
echo " "
echo "Options (default: Shuffle All Cards)"
echo "************************"
echo "q: Quit"
echo "1: Keep Card"
echo "0: Shuffle Card"
...
#Pair
if [[ $cardComp1 = $cardComp2 ]];then
currentWin="${WIN}Win!!! Pair"
myPair=1
fi
if [[ $cardComp1 = $cardComp3 ]];then
currentWin="${WIN}Win!!! Pair"
myPair=1
fi
if [[ $cardComp1 = $cardComp4 ]];then
currentWin="${WIN}Win!!! Pair"
myPair=1
fi
if [[ $cardComp1 = $cardComp5 ]];then
currentWin="${WIN}Win!!! Pair"
myPair=1
fi
if [[ $cardComp2 = $cardComp3 ]];then
currentWin="${WIN}Win!!! Pair"
myPair=1
fi
if [[ $cardComp2 = $cardComp4 ]];then
currentWin="${WIN}Win!!! Pair"
myPair=1
fi
if [[ $cardComp2 = $cardComp5 ]];then
currentWin="${WIN}Win!!! Pair"
myPair=1
fi
if [[ $cardComp3 = $cardComp4 ]];then
currentWin="${WIN}Win!!! Pair"
myPair=1
fi
if [[ $cardComp3 = $cardComp5 ]];then
currentWin="${WIN}Win!!! Pair"
myPair=1
fi
if [[ $cardComp4 = $cardComp5 ]];then
currentWin="${WIN}Win!!! Pair"
myPair=1
fi
#Two Pair
